...
function DcfTable({ assumptions, equityMid, detailed }: { assumptions: Record<string, unknown>; equityMid?: number; detailed?: boolean }) {
  return (
...
function NavTable({ components, equityMid, detailed }: { components: Record<string, number>; equityMid?: number; detailed?: boolean }) {
  return (
    <table className="mt-2 w-full text-xs">
      <thead>
        <tr className="border-b border-[color:var(--line)]">
